        ...
        <div className="bg-cream-card border border-forest-dark/15 rounded-3xl p-6 md:p-10 w-full max-w-lg shadow-sm flex flex-col gap-8 shrink-0">
          ...
          <div className="flex flex-col">
            ...
            <div className="border-t border-forest-dark/10 pt-5">
              {!isConnected ? (
                <p className="text-[10px] text-forest-muted/75 italic text-center">
                  Showing vault-wide metrics. Connect wallet to view your position.
                </p>
              ) : (
        ...
        <div className="bg-cream-card border border-forest-dark/15 rounded-3xl p-6 md:p-10 w-full max-w-lg shadow-sm flex flex-col gap-6 shrink-0">
          ...
          {!isConnected ? (
            <div className="bg-forest-dark/5 border border-forest-dark/10 rounded-2xl p-6 text-center">
              <p className="text-xs text-forest-muted mb-4">Connect your wallet to start depositing.</p>
              <button
                onClick={handleConnect}
                className="w-full bg-forest-dark text-cream-light text-xs font-bold uppercase tracking-wider py-3.5 rounded-xl hover:bg-forest-dark/95 transition-all cursor-pointer"
              >
                Connect Wallet
              </button>
            </div>
